...
from lesson_19.homework_19_1 import nasa_photos
...
@pytest.mark.nasa
@pytest.mark.parametrize ("sol, camera, api_key",[(1000, 'fhaz', 'DEMO_KEY')])
...
#      response = NasaController().get_photos(1000, 'fhaz', 'DEMO_KEY')
#      assert response.status_code == 403


def test_save_nasa_photos():

    photos_dir = nasa_photos(sol=1000, camera="fhaz", api_key="DEMO_KEY")
